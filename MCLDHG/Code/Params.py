...
def ParseArgs():
    ...
    parser.add_argument('--tstBat', default=32, type=int, help='number of interactions in a testing batch')
    ...
    parser.add_argument('--hyperNum', default=512, type=int, help='number of hyperedges')
    ...
    parser.add_argument('--data', default='Micro', type=str, help='name of dataset')
    ...
    parser.add_argument('--top_1', type=int, default=1,help='hit@top,ndcg@top')
    parser.add_argument('--top_3', type=int, default=3,help='hit@top,ndcg@top')
    parser.add_argument('--top_5', type=int, default=5,help='hit@top,ndcg@top')
